...
import com.joy.joymall.coupon.service.MemberPriceService;
import com.joy.joymall.coupon.service.SkuLadderService;
...
import com.joy.joymall.coupon.dao.SkuFullReductionDao;
...
//        skuLadderEntity.setPrice();
        ...
        List<MemberPriceEntity> memberPriceEntities = memberPrice.stream().map((entity) -> {
            MemberPriceEntity memberPriceEntity = new MemberPriceEntity();
            memberPriceEntity.setSkuId(skuReductionTo.getSkuId());
            memberPriceEntity.setMemberLevelId(entity.getId());
            memberPriceEntity.setMemberLevelName(entity.getName());
            memberPriceEntity.setMemberPrice(entity.getPrice());
            memberPriceEntity.setAddOther(1);

            return memberPriceEntity;
        }).filter((priceEntity) -> priceEntity.getMemberPrice().compareTo(new BigDecimal(0)) > 0)
